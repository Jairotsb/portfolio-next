...
**CTO** | [ESHGO Software House](https://eshgo.com.br) | Seção de tecnologia da informação - **Força Aérea Brasileira** | Especialista em monitoramento de redes em larga escala (+3.000 Ativos) | **Engenharia da Computação** (Uniamérica, 2027)
